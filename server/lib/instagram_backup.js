...
function getConfig() {
  return {
    appId: process.env.FACEBOOK_APP_ID || "962298186385317",
    appSecret: process.env.FACEBOOK_APP_SECRET || "300c2add5733c03007d61f6411655cb2",
    redirectUri: process.env.INSTAGRAM_REDIRECT_URI || "https://crm.parrobyte.co.in/instagram/oauth/callback",
  };
}
...
export function getAuthUrl(state = "") {
  ...
  return `https://www.instagram.com/v18.0/dialog/oauth?client_id=${cfg.appId}&redirect_uri=${encodeURIComponent(cfg.redirectUri)}&scope=${encodeURIComponent(scope)}&state=${encodeURIComponent(state)}&response_type=code`;
}
